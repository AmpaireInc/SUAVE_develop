...
## @ingroup Analyses-Mission-Segments-Climb
class Constant_Throttle_Constant_CAS(Aerodynamic):
    """ Climb at a constant throttle setting and calibrated airspeed.
    ...
    def __defaults__(self):
        ...
        initialize.conditions              = Methods.Climb.Constant_Throttle_Constant_CAS.initialize_conditions
        initialize.velocities              = Methods.Climb.Constant_Throttle_Constant_CAS.update_velocity_vector_from_wind_angle
        initialize.differentials_altitude  = Methods.Climb.Constant_Throttle_Constant_CAS.update_differentials_altitude      
        ...
        iterate.unknowns.mission           = Methods.Climb.Constant_Throttle_Constant_CAS.unpack_body_angle 
        
        # Update Conditions
        iterate.conditions = Process()
        iterate.conditions.velocities      = Methods.Climb.Constant_Throttle_Constant_CAS.update_velocity_vector_from_wind_angle
        iterate.conditions.differentials_a = Methods.Climb.Constant_Throttle_Constant_CAS.update_differentials_altitude
