...
# ----------------------------------------------------------------------
## @ingroup Components-Energy-Networks
class Internal_Combustion_Propeller_Table(Network):
    ...
    def evaluate_thrust(self,state):
        ...
        for ii in range(n_evals):  
            ...
            conditions.propulsion.commanded_power = engine.power(conditions).power
            ...
            conditions.propulsion.throttle                   = engine_throttle #added this line to make sure throttles match
