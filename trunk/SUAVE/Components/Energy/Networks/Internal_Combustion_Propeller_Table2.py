...
# ----------------------------------------------------------------------
## @ingroup Components-Energy-Networks
class Internal_Combustion_Propeller_Table2(Network):
    ...
    def evaluate_thrust(self,state):
        ...
        for ii in range(n_evals):     
            ...
            conditions.propulsion.commanded_power = engine.outputs.power
            #print("torque: ", torque)
            ...
            conditions.propulsion.propeller_power_coefficient         = Cp[:,0]
